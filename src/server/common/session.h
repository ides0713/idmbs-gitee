...
public:
    ParseSession(DataBase *database = nullptr, Txn *txn = nullptr, bool txn_multi_operation = false,
                 Query *query = nullptr)
...
public:
    ResolveSession(DataBase *database = nullptr, Txn *txn = nullptr, bool txn_multi_operation = false,
