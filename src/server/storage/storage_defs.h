...
/// @brief getFrame path of database directory path with bin directory path and database name
std::filesystem::path getDataBasePath(std::filesystem::path bin_path, const char *database_name);

///@brief getFrame path of table meta file's path([table_name].table) with database directory path and table name
std::filesystem::path getTableMetaFilePath(std::filesystem::path database_path, const char *table_name);

///@brief getFrame path of table data file's path([table_name].data) with database directory path and table name
