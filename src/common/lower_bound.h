...
ForwardIterator FindLowerBound(ForwardIterator first, ForwardIterator last, const T &val, Compare comp,
                               bool *_found = nullptr) {
    bool found = false;
...
ForwardIterator FindLowerBound(ForwardIterator first, ForwardIterator last, const T &val, bool *_found = nullptr) {
    return FindLowerBound<ForwardIterator, T, Comparator<T>>(first, last, val, Comparator<T>(), _found);
}
